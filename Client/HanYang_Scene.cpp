...
HanYang_Scene::HanYang_Scene() :m_pGameObject_Manager(CGameObject_Manager::Get_Instance())
{
}

HanYang_Scene::~HanYang_Scene()
{
	Release_Scene();

}

HRESULT HanYang_Scene::LoadData_MAPObject(const wstring & wstrFilePath)
{
...
HRESULT HanYang_Scene::LoadData_TILEObject(const wstring & wstrFilePath)
{
	HANDLE hFile = CreateFile(wstrFilePath.c_str(), GENERIC_READ, 0, nullptr, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, nullptr);
	if (INVALID_HANDLE_VALUE == hFile)
		return E_FAIL;
...
HRESULT HanYang_Scene::LoadData_Object(const wstring & wstrFilePath)
{
	HANDLE hFile = CreateFile(wstrFilePath.c_str(), GENERIC_READ, 0, nullptr, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, nullptr);
	if (INVALID_HANDLE_VALUE == hFile)
		return E_FAIL;
...
HRESULT HanYang_Scene::Ready_Scene()
{
	...
	LoadData_TILEObject(L"../Data/BattleMap_TileData41.dat");
	...
	//
	LoadData_MAPObject(L"../Data/BattleMap_ObjectData3.dat");
	LoadData_Object(L"../Data/BattleMap_UnitData30.dat");
...
void HanYang_Scene::Update_Scene()
{
	m_pGameObject_Manager->Update_GameObject_Manager();

}

void HanYang_Scene::Render_Scene()
{//SeaMap1
...
void HanYang_Scene::Release_Scene()
{
