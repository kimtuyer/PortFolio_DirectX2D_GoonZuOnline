...
CTDmgNumber::CTDmgNumber() : m_tFrame({}),
m_fSpeed(0)
{
...
CTDmgNumber::~CTDmgNumber()
{
	Release_GameObject();

}

int CTDmgNumber::FrameMove(float fSpeed)
{
...
void CTDmgNumber::Move()
{
}

HRESULT CTDmgNumber::Ready_GameObject()
{
...
int CTDmgNumber::Update_GameObject()
{
...
void CTDmgNumber::Late_Update_GameObject()
{
}

void CTDmgNumber::Render_GameObject()
{
	if (m_life != 0)
	{
		m_tInfo.vDir = m_vGoalPos - m_tInfo.vPos;
		...
		//int index = pTerrain->Get_TileIndex(m_vGoalPos);
		pTexInfo = CTexture_Manager::Get_Instance()->Get_TexInfo_Manager(L"CdmgNumber", StateKey, (DWORD)m_tFrame.fFrameStart);
		//if(pTexInfo=nullptr)
		{
...
void CTDmgNumber::Release_GameObject()
{
}

void CTDmgNumber::Set_Dir()
{
}
