...
FireArrow_Player::FireArrow_Player() : m_tFrame({}),
...
FireArrow_Player::~FireArrow_Player()
{
	Release_GameObject();

}

void FireArrow_Player::FrameMove(float fSpeed)
{
...
void FireArrow_Player::Move()
{
}

HRESULT FireArrow_Player::Ready_GameObject()
{
	m_ebullet = Bullet_ID::fire;
...
int FireArrow_Player::Update_GameObject()
{
...
void FireArrow_Player::Late_Update_GameObject()
{
...
void FireArrow_Player::Render_GameObject()
{
	if (m_life != 0)
	{
		m_tInfo.vDir = m_vGoalPos - m_tInfo.vPos;
		...
		//int index = pTerrain->Get_TileIndex(m_vGoalPos);
		pTexInfo = CTexture_Manager::Get_Instance()->Get_TexInfo_Manager(L"firearrow", StateKey, (DWORD)m_tFrame.fFrameStart);
		//if(pTexInfo=nullptr)
		{
...
void FireArrow_Player::Release_GameObject()
{
}

void FireArrow_Player::Set_Dir()
{
	if (m_life != 0)
	{
		m_tInfo.vDir = m_vGoalPos - m_tInfo.vPos;
