...
int CGageBar::FrameMove(float fSpeed)
{
...
HRESULT CGageBar::Ready_GameObject()
{
...
int CGageBar::Update_GameObject()
{
FrameMove(0.5f);
...
void CGageBar::Late_Update_GameObject()
{
}

void CGageBar::Render_GameObject()
{
	//if (m_life != 0)
	{
		...
		//int index = pTerrain->Get_TileIndex(m_vGoalPos);
		pTexInfo = CTexture_Manager::Get_Instance()->Get_TexInfo_Manager(L"GageBar", StateKey, (DWORD)m_tFrame.fFrameStart);
		//if(pTexInfo=nullptr)
		{
...
void CGageBar::Release_GameObject()
{
}
