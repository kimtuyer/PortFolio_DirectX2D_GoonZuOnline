...
CdmgNumber2::CdmgNumber2() : m_tFrame({}),
m_fSpeed(0)
{
...
CdmgNumber2::~CdmgNumber2()
{
	Release_GameObject();

}

int CdmgNumber2::FrameMove(float fSpeed)
{
...
void CdmgNumber2::Move()
{
}

HRESULT CdmgNumber2::Ready_GameObject()
{
	m_tInfo.vDir = { 1.f, 1.f, 0.f };
	m_tInfo.vSize = { 2, 2, 0.f };
	m_tFrame = { 0.f, 1.f };
	m_fSpeed = 300.f;
	StateKey = L"100";
...
int CdmgNumber2::Update_GameObject()
{
...
void CdmgNumber2::Late_Update_GameObject()
{
}

void CdmgNumber2::Render_GameObject()
{
	if (m_life != 0)
	{
		m_tInfo.vDir = m_vGoalPos - m_tInfo.vPos;
		...
		//int index = pTerrain->Get_TileIndex(m_vGoalPos);
		pTexInfo = CTexture_Manager::Get_Instance()->Get_TexInfo_Manager(L"CdmgNumber2", StateKey, (DWORD)m_tFrame.fFrameStart);
		//if(pTexInfo=nullptr)
		{
...
void CdmgNumber2::Release_GameObject()
{
}

void CdmgNumber2::Set_Dir()
{
}
