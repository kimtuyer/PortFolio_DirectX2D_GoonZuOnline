...
HRESULT CMulti_Texture::Insert_Texture(const wstring & wstrFilePath, D3DCOLOR color = (255, 0, 0, 0),const wstring & wstrStateKey /*= L""*/, const DWORD & dwCount /*= 0*/)
{
	D3DCOLOR color1;
	if (wstrStateKey == L"Tile")
	{
		 color1 = D3DCOLOR_ARGB(255, 255, 255, 255);
	}
	else if (wstrStateKey == L"Summon")
	{
		color1 = D3DCOLOR_ARGB(255, 247, 0, 255);
	}
